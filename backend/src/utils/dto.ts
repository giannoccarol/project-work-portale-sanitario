...
export function toUserDto(user: User, includeEmail = true) {
  return {
    id: user.id,
...
export function toPatientDto(patient: Patient, includeClinicalData = false, includeIdentity = true) {
  return {
    id: patient.id,
    user: patient.user ? toUserDto(patient.user) : undefined,
...
export function toDoctorDto(doctor: Doctor, includeEmail = false) {
  return {
    id: doctor.id,
    user: doctor.user ? toUserDto(doctor.user, includeEmail) : undefined,
